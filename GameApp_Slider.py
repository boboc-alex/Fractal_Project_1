...
class Slider():
        def __init__(self, pos: tuple, size: tuple, inital_val: float, min_val: float, max_val: float):
            ...
            # self.inital_val = (self.slider_right_pos - self.slider_left_pos) * inital_val # <-- percentage value
                
            # self.slider_rect = pygame.Rect(self.slider_left_pos, self.slider_top_pos, self.size[0], self.size[1])
        ...
        #not sure how this works 100 percent
